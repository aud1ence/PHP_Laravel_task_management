                ...
                @forelse($products as $key => $product)
                    <div class="col mb-5">
                        <div class="card h-100">
                            <!-- Product image-->
                            <img class="card-img-top" style="max-height: 150px" src="{{asset("storage/products/$product->image")}}" alt="..."/>
                            <!-- Product details-->
                            ...
                            <div class="row">
                                ...
                                <div class="card-footer p-4 pt-0 border-top-0 bg-transparent col">
                                    <div class="text-center">
                                        <a class="btn btn-outline-success mt-auto" href="{{ route('products.show', $product->id) }}">View options</a>
                                    </div>
                                </div>
                            </div>
